            ...
            <form class="col-sm-6   form-inline">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-8">
                        ...
                        <button type="button" id="submit" class="btn btn-primary col-sm-3" >注册</button>
                        <div class="col-sm-1"></div>
                        <button type="reset" id="reset" class="btn btn-primary col-sm-3">重置</button>
...
<script>
    ...
    $(function () {
        ...
        function validate() {
            ...
            //验证地址
            var mes5 = verificationAddress(address);
            if (mes5 != null) {
                waringBorderAndSpan($('#address').get(0), mes5);
                return false;
            }
            //验证通过提交注册
            $.ajax({
                url: '<%=context%>/vipCenterAction/vipRegister.do',
